...
# datasets = ['ecoli', 'satimage', 'abalone', 'spectrometer', 'scene']
...
for dataset in datasets:
    ...
    dict_metrics_1, num_folds = handle_dataset(X_temp.drop('y', 1), y, dict(), False, num_folds=INITIAL_FOLDS)
    dict_metrics_2, num_folds_gamma = handle_dataset(X_temp.drop('y', 1), y, dict(), True, num_folds=INITIAL_FOLDS,
                                                     n_neighbours=5)
